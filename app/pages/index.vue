<template>
  <main class="py-12 px-6 max-w-5xl mx-auto leading-relaxed">
    ...
    <p class="mb-4 text-lg">
      ...
      new recruit, this experience is designed for everyone.
    </p>
    ...
    <p class="mb-4 text-lg">
      ...
      the heroes who carried this war on their shoulders, you can visit our
      <a href="/characters" class="gears-link__not-animated">
        Characters Page </a
      >.
    </p>

    <img
      src="/marcusSonFight.webp"
      class="mb-10"
